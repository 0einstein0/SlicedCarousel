(function() {
    ...
    var yearEl = [].slice.call(document.querySelectorAll('.pieces-slider__year'));
    ...
    for (var i = 0; i < slidesLength; i++) {
        ...
        items.push({type: 'text', value: yearEl[i].getAttribute('value'), options: numberOptions});
        // Save indexes
